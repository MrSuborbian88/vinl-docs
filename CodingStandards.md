...
# Use 'sesskey' mechanism to protect form handling routines from attack. Basic example of use: when form is generated, include 

&lt;input type="hidden" name="sesskey" value="&lt;?php echo sesskey(); ?&gt;" /&gt;

. When you process the form check with if (!confirmsesskey()) { printerror('confirmsesskeybad');}.
